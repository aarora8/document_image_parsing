...
def rotated_points(bounding_box, center):
    ...
    curr_rotation_angle = bounding_box.unit_vector_angle
    if curr_rotation_angle > pi / 2:
        curr_rotation_angle = bounding_box.unit_vector_angle
        curr_rotation_angle = pi - curr_rotation_angle

    rotation_angle_in_rad = -curr_rotation_angle
...
def get_line_images_from_page_image_line(image_file_name, madcat_file_path):
    ...
    for node in zone:
        ...
        if id == 'z2':
            ...
            if rotation_angle_in_rad > pi/2:
                rotation_angle_in_rad = pi - bounding_box.unit_vector_angle
