...
from math import atan2, cos, sin, pi, degrees, atan
...
def rotated_points(bounding_box, center):
    ...
    rotation_angle_in_rad = -get_horizontal_angle(bounding_box.unit_vector_angle)
...
def get_line_images_from_page_image_line(image_file_name, madcat_file_path):
    ...
    for node in zone:
        ...
        if id == 'z15':
            ...
            print(degrees(get_horizontal_angle(bounding_box.unit_vector_angle)))

            ortho_vector = orthogonal_vector(bounding_box.unit_vector)
            new_given_angle = atan2(ortho_vector[1], ortho_vector[0])
            print(ortho_vector)
            print(degrees(new_given_angle))
            print(degrees(get_horizontal_angle(new_given_angle)))
